...
const productos = [
  ...
  },
  {
    ...
    nombre: 'NBA 2K23',
    descripcion:
      'NBA 2K23 trae de vuelta el mejor baloncesto de 2K Sports, que durante dos décadas ha logrado establecerse como una pieza clave de la cultura del baloncesto al crear videojuegos de basket con una experiencia inmersiva en la palma de la mano de cada jugador.',
    precio: 220,
    categoria: 'deportes',
    stock: 5,
    imagen: '/img/nba.webp',
  ...
  },
  {
    ...
    nombre: 'Cuphead',
    descripcion:
      'Un indie de categoría como Cuphead regresa con un DLC que expande la acción del videojuego con nuevos jefes, más armas para hacerles frente ¡y nueva protagonista! en Cuphead The Delicious Last Course.',
    precio: 600,
    categoria: 'accion',
    stock: 15,
